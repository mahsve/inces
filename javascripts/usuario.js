                ...
                try {
                    ...
                    if (dataListado.resultados) {
                        for (var i in dataListado.resultados) {
                            ...
                            contenido += '<td class="py-2 px-1">'+dataListado.resultados[i].usuario+'</td>';
                            ...
                            if (dataListado.resultados[i].tipo_persona == 'A')
                                contenido += '<td class="py-2 px-1">Administrador</td>';
                            else if (dataListado.resultados[i].tipo_persona == 'F')
                                contenido += '<td class="py-2 px-1">Facilitador</td>';
                            else if (dataListado.resultados[i].tipo_persona == 'C')
                                contenido += '<td class="py-2 px-1">Contacto de empresa</td>';
                            
                            contenido += '<td class="py-2 px-1">'+dataListado.resultados[i].rol+'</td>';
                            ...
                            else if (dataListado.resultados[i].estatus == 'C')
                                contenido += '<td class="text-center py-2 px-1"><span class="badge badge-danger"><i class="fas fa-ban mr-1"></i>Bloqueado</span></td>';
