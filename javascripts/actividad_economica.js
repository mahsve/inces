            ...
            data: {
                ...
                try {
                    ...
                    if (dataListado.resultados) {
                        ...
                        $('#listado_tabla tbody').append('<tr><td colspan="4" class="text-center text-secondary border-bottom p-2"><i class="fas fa-file-alt mr-3"></i>No hay actividades registradas</td></tr>');
                    }
