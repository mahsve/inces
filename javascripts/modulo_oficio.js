$(function () {
                ...
                success: function (resultados) {
                    ...
                    if (dataListado.resultados) {
                        ...
                        for (var i in dataListado.resultados) {
                            ...
                            contenido_tabla += '<td class="py-2 px-1">'+dataListado.resultados[i].oficio+'</td>';
                        ...
                        contenido_tabla += '<tr>';
                        contenido_tabla += '<td colspan="'+filas+'" class="text-center text-secondary border-bottom p-2">';
                        contenido_tabla += '<i class="fas fa-file-alt"></i> <span style="font-weight: 500;"> No hay modulos registrados.</span>';
                        contenido_tabla += '</td>';
                        contenido_tabla += '</tr>';
                        $('#listado_tabla tbody').html(contenido_tabla);
                    }
    ...
    function verificarParte1() {
        ...
        if (codigo != "") {
            if (codigo.match(validar_codigoFormulario)) {
