$(function () {
                ...
                success: function (resultados){
                    ...
                    if (dataListado.resultados) {
                        ...
                        for (var i in dataListado.resultados) {
                            let enfoque_td = '';
                            if      (dataListado.resultados[i].formulario == 'A') { enfoque_td = 'Aprendiz'; }
                            else if (dataListado.resultados[i].formulario == 'B') { enfoque_td = 'Familia del aprendiz'; }
                            else if (dataListado.resultados[i].formulario == 'F') { enfoque_td = 'Facilitador'; }
                            ...
                            contenido += '<td class="py-2 px-1">'+enfoque_td+'</td>';
    ...
    function verificarParte1 () {
        ...
        if (c_formulario != '') {
            ...
            $("#c_formulario").css("background-color", colorm);
            pestania1 = false;
        }
    }
    /////////////////////////////////////////////////////////////////////
