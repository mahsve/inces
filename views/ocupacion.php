<?php
include_once('models/m_ocupacion.php');
$objeto = new model_ocupacion();
$objeto->conectar();
$ocupaciones = $objeto->consultarOcupaciones();
...
<div class="d-flex align-items-center justify-content-between border-bottom pb-2 mb-2">
    ...
    <?php if ($permisos['registrar']) { ?>
        <a href="gestion_ocupacion" class="btn btn-sm btn-info"><i class="fas fa-plus"></i><span class="ml-1">Registrar</span></a>
    <?php } ?>
</div>
        ...
        <tr class="text-capitalize">
            ...
            <td class="align-middle p-2">
                <?php if ($permisos['modificar']) { ?>
                    <a href="<?php echo 'gestion_ocupacion/'.$datos['codigo']; ?>" class="btn btn-sm btn-info"><i class="fas fa-edit"></i></a>
                <?php } ?>
...
<script>
    $(function () {
        ...
        function cambiarEstatus ()
        {
            ...
            $.ajax({
                url : '<?php echo SERVERURL.'controllers/c_ocupacion.php'; ?>',
                type: 'POST',
                data: {
                    opcion: 'Estatus',
                    codigo: codigo,
