...
<form class="formulario" action="../controllers/c_empresa.php" method="POST" name="formulario">
    ...
    <input type="hidden" name="rif2"/>
  
    <h5 class="font-weight-normal">Datos de la empresa</h5>
    <div class="form-row">
        <div class="col-sm-2">
            <div class="form-group has-warning mb-2">
                <label for="rif" class="small m-0">RIF <span class="text-danger">*</span></label>
                <input type="text" class="form-control form-control-sm" name="rif" id="rif" maxlength="12" placeholder="Ingrese el RIF" required/>
            </div>
        </div>
        ...
        <div class="col-sm-2">
            <div class="form-group has-warning mb-2">
                ...
                <input type="text" class="form-control form-control-sm" name="nil" id="nil" maxlength="12" placeholder="Ingrese el NIL" required/>
            </div>
        </div>
        ...
        <div class="col-sm-5">
            <div class="form-group has-warning mb-2">
                ...
                <input type="text" class="form-control form-control-sm" name="razon_social" id="razon_social" maxlength="100" placeholder="Ingrese la razón social" required/>
            </div>
        </div>
        ...
        <div class="col-sm-3">
            <div class="form-group has-warning mb-2">
                ...
                <select class="custom-select custom-select-sm" name="actividad_economica" id="actividad_economica" required>
                    <?php if ($actividades) {?>
        ...
        <div class="col-sm-2">
            <div class="form-group has-warning mb-2">
                ...
                <input type="text" class="form-control form-control-sm" name="codigo_aportante" id="codigo_aportante" maxlength="12" placeholder="Ingrese el código de aportante" required/>
            </div>
        </div>
        ...
        <div class="col-sm-2">
            <div class="form-group has-warning mb-2">
                ...
                <input type="text" class="form-control form-control-sm" name="telefono_1" id="telefono_1" maxlength="11" placeholder="Ingrese el telefono" required/>
            </div>
        </div>
        ...
        <div class="col-sm-12">
            <div class="form-group has-warning mb-2">
                ...
                <textarea name="direccion" id="direccion" class="form-control form-control-sm" required placeholder="Ingrese la dirección física de la empresa"></textarea>
            </div>
        </div>
    </div>

    <h5 class="font-weight-normal">Persona de contacto</h5>
    <div class="form-row">
        <div class="col-sm-2">
            <div class="form-group has-warning mb-2">
