<div id="info_table">
    ...
    <div class="table-responsive pb-2">
        <table id="listado_tabla" class="table table-borderless table-hover mb-0" style="min-width: 950px;">
            <thead>
                <tr class="text-white">
                    <th class="bg-info font-weight-normal px-1 py-2 rounded-left" width="90">Registro</th>
            ...
            <ul class="nav nav-pills mb-2" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="pills-datos-ciudadano-tab" data-toggle="pill" href="#pills-datos-ciudadano" role="tab" aria-controls="pills-datos-ciudadano" aria-selected="true">
                        <i class="fas fa-book-reader"></i><span class="ml-1">Aspirante</span><i id="icon-ciudadano" class="fas fa-exclamation-triangle icon-alert ml-2" style="display: none;"></i>
                    </a>
                </li>
                <li class="nav-item">
            ...
            <div class="tab-content border rounded position-relative">
                ...
                <div id="pills-datos-ubicacion" class="tab-pane fade px-3 py-2" role="tabpanel" aria-labelledby="pills-datos-ubicacion-tab">
                    <div class="form-row">
                        ...
                        <!-- TITULO -->
                        <div class="col-sm-12 mt-4">
                            <h4 class="font-weight-normal text-secondary text-center text-uppercase">Observación</h4>    
                        </div>

                        <!-- OBSERVACION -->
                        <div class="col-sm-12">
                            <div class="form-group mb-2">
                                <label for="observacion_aspirante" class="d-inline-block w-100 position-relative small m-0">Observación<i class="fas fa-asterisk text-danger position-absolute required"></i></label>
                                <textarea type="text" name="observacion_aspirante" id="observacion_aspirante" class="campos_formularios form-control form-control-sm" placeholder="Ingrese punto de refencia" autocomplete="off" maxlength="200" style="height: 100px;"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
...
<script src="<?php echo SERVERURL; ?>javascripts/aspirante.js"></script>