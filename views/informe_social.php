<div id="info_table" style="">
        ...
        <div class="col-sm-12 col-xl-8">
            <div class="form-row">
                ...
                <div class="col-sm-6 col-lg-3 col-xl-3 form-group d-flex align-items-center text-info mb-2">
                    <label for="buscar_por" class="pr-2 m-0"><i class="fas fa-sort-alpha-down"></i></label>
                    <select id="buscar_por" class="custom-select custom-select-sm">
    ...
    <div class="row mt-2">
        <div class="col-sm-6 d-flex align-items-center small font-weight-bold">
            Registros del 1 - 10 / 15 en total
        </div>
