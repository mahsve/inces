<?php
include_once('models/m_actividad_economica.php');
$objeto = new model_actividad_economica();
$objeto->conectar();
$actividades = $objeto->consultarActividadesEconomicas();
...
<div class="d-flex align-items-center justify-content-between border-bottom pb-2 mb-2">
    ...
    <?php if ($permisos['registrar']) { ?>
        <a href="gestion_actividad_economica" class="btn btn-sm btn-info"><i class="fas fa-plus"></i><span class="ml-1">Registrar</span></a>
    <?php } ?>
</div>
        ...
        <tr class="text-capitalize">
            ...
            <td class="align-middle p-2">
                <?php if ($permisos['modificar']) { ?>
                    <a href="<?php echo 'gestion_actividad_economica/'.$datos['codigo']; ?>" class="btn btn-sm btn-info"><i class="fas fa-edit"></i></a>
                <?php } ?>
...
<script>
    $(function () {
        ...
        function cambiarEstatus ()
        {
            ...
            $.ajax({
                url : '<?php echo SERVERURL.'controllers/c_actividad_economica.php'; ?>',
                type: 'POST',
                data: {
                    opcion: 'Estatus',
                    codigo: codigo,
