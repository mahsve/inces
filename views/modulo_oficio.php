<div id="info_table">
    ...
    <div class="row align-items-center justify-content-between">
        ...
        <div class="form-group col-sm-12 col-xl-3 d-flex align-items-center text-info position-relative mb-2">
            ...
            <input type="text" id="campo_busqueda" class="campos_de_busqueda form-control form-control-sm" style="padding-right: 30px;" placeholder="Buscar por código o nombre" autocomplete="off"/>
        </div>
    </div>
            ...
            <div class="form-row">
                <div class="col-sm-12 offset-md-3 col-md-6">
                    ...
                    <div class="form-group mb-2">
                        ...
                        <input type="text" name="nombre" id="nombre" class="campos_formularios form-control form-control-sm" placeholder="Ingrese el módulo" autocomplete="off"/>
                    </div>

                    <div class="form-group mb-2">
                        <label for="oficio" class="d-inline-block w-100 position-relative small m-0">Formulario<i class="fas fa-asterisk text-danger position-absolute required"></i></label>
...
<script src="<?php echo SERVERURL; ?>javascripts/modulo_oficio.js"></script>