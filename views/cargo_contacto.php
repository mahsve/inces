        ...
        <table id="listado_tabla" class="table table-borderless table-hover mb-0" style="min-width: 950px;">
            <thead>
                <tr class="text-white">
                    ...
                    <th class="bg-info font-weight-normal px-1 py-2">Nombre del cargo</th>
            ...
            <div class="form-row">
                <div class="col-sm-12 offset-md-3 col-md-6">
                    <div class="form-group mb-2">
                        ...
                        <input type="text" name="nombre" id="nombre" class="campos_formularios form-control form-control-sm" placeholder="Ingrese el cargo" autocomplete="off"/>
                    </div>
...
<script src="<?php echo SERVERURL; ?>javascripts/cargo_contacto.js"></script>