...
<div class="d-flex align-items-center justify-content-between border-bottom pb-2 mb-2">
    ...
    <?php if ($permisos['registrar']) { ?>
        <a href="gestion_oficio" class="btn btn-sm btn-info"><i class="fas fa-plus"></i><span class="ml-1">Registrar</span></a>
    <?php } ?>
</div>
...
<table id="listado" class="table table-bordered table-hover w-100">
    <thead class="">
        <tr class="text-capitalize">
            ...
            <th width="80" class="font-weight-normal p-2">Estatus</th>
...
<script>
    $(function () {
        ...
        function cambiarEstatus ()
        {
            ...
            $.ajax({
                url : '<?php echo SERVERURL.'controllers/c_oficio.php'; ?>',
                type: 'POST',
                data: {
                    opcion: 'Estatus',
                    codigo: codigo,
