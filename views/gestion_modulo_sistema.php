<?php
    ...
    {
        include_once('models/m_modulo_sistema.php'); // INCLUIMOS EL MODELO PARA CONSULTAR A LA BASE DE DATOS.
        $objeto = new model_modulo_sistema(); // CREAMOS UN NUEVO OBJETO PARA ACCEDER A LOS METODOS.
...
<div class="d-flex align-items-center justify-content-between border-bottom pb-2 mb-2">
    ...
    <a href="<?php echo SERVERURL.'intranet/modulo_sistema'; ?>" class="btn btn-sm btn-info"><i class="fas fa-reply"></i><span class="ml-1">volver</span></a>
</div>

<form class="formulario" action="<?php echo SERVERURL.'controllers/c_modulo_sistema.php'; ?>" method="POST" name="formulario">
    ...
    <div class="form-row">
        <div class="offset-sm-3 col-sm-6">
            <div class="form-group has-warning mb-2">
                <label for="icon" class="small m-0">Icono <span class="text-danger">*</span></label>
                <input type="text" class="form-control form-control-sm" name="icon" id="icon" maxlength="20" value="<?php if (isset($consulta)) { echo $consulta['icon']; } ?>" required/>
            </div>
        </div>
    </div>
