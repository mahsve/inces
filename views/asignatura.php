        ...
        <div class="form-row">
            <div class="col-sm-12 offset-md-3 col-md-6">
                ...
                <div class="form-group has-warning mb-2">
                    ...
                    <input type="text" name="nombre" id="nombre" class="form-control form-control-sm" placeholder="Ingrese el Nombre" autocomplete="off"/>
                </div>
                ...
                <div class="form-group mb-2">
                        <label for="modulo" class="d-inline-block w-100 position-relative small m-0">Modulo<i class="fas fa-asterisk text-danger position-absolute required"></i></label>
...
<script src="<?php echo SERVERURL; ?>javascripts/asignatura.js"></script>