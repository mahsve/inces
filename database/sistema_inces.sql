...
CREATE TABLE IF NOT EXISTS `sistema_inces`.`t_parroquia` (
  ...
  `estatus` CHAR(1) NOT NULL DEFAULT 'A',
  PRIMARY KEY (`codigo`),
  INDEX `fk_municipio_parroquia_idx` (`codigo_municipio` ASC),
  CONSTRAINT `fk_municipio_parroquia`
...
CREATE TABLE IF NOT EXISTS `sistema_inces`.`t_datos_personales` (
  ...
  INDEX `fk_parroquia_datos_personales_idx` (`codigo_parroquia` ASC),
  ...
  CONSTRAINT `fk_ocupacion_datos_personales`
    ...
    ON DELETE NO ACTION
    ON UPDATE CASCADE,
  CONSTRAINT `fk_parroquia_datos_personales`
...
CREATE TABLE IF NOT EXISTS `sistema_inces`.`t_empresa` (
  ...
  `codigo_actividad_e` INT NOT NULL,
  `codigo_aportante` CHAR(12) NULL,
  `telefono1` CHAR(11) NOT NULL,
  `telefono2` CHAR(1) NULL,
  `codigo_ciudad` INT NOT NULL,
  ...
  INDEX `fk_actividad_economica_empresa_idx` (`codigo_actividad_e` ASC),
  ...
  CONSTRAINT `fk_actividad_economica_empresa`
    FOREIGN KEY (`codigo_actividad_e`)
...
CREATE TABLE IF NOT EXISTS `sistema_inces`.`t_informe_social` (
  ...
  `condicion_vivienda` VARCHAR(1000) NULL,
  `caracteristicas_generales` VARCHAR(1000) NULL,
  `diagnostico_social` VARCHAR(1000) NULL,
  `enfermos` CHAR(1) NOT NULL,
  `diagnostico_preliminar` VARCHAR(1000) NULL,
...
CREATE TABLE IF NOT EXISTS `sistema_inces`.`t_bitacora` (
  ...
  `valor_viejo` VARCHAR(60) NULL,
  `valor_nuevo` VARCHAR(60) NULL,
  PRIMARY KEY (`numero`),
...
CREATE TABLE IF NOT EXISTS `sistema_inces`.`t_asignatura` (
  ...
  `estatus` CHAR(1) NOT NULL DEFAULT 'A',
  PRIMARY KEY (`codigo`),
  INDEX `fk_modulo_asignatura_idx` (`codigo_modulo` ASC),
  CONSTRAINT `fk_modulo_asignatura`
...
CREATE TABLE IF NOT EXISTS `sistema_inces`.`td_asignatura` (
  ...
  `cedula_facilitador` VARCHAR(10) NULL,
...
-- -----------------------------------------------------
-- Table `sistema_inces`.`t_registro_rol`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sistema_inces`.`t_registro_rol` (
  `tipo_persona` CHAR(1) NOT NULL,
  `codigo_rol` INT NOT NULL,
  INDEX `fk_t_rol_registro_persona_idx` (`codigo_rol` ASC),
  CONSTRAINT `fk_t_rol_registro_persona`
    FOREIGN KEY (`codigo_rol`)
    REFERENCES `sistema_inces`.`t_rol` (`codigo`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
