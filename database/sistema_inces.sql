...
-- -----------------------------------------------------
-- Table `sistema_inces`.`td_oficio_asignatura`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sistema_inces`.`td_oficio_asignatura` (
  `codigo` INT NOT NULL AUTO_INCREMENT,
  `codigo_oficio` INT NOT NULL,
  `codigo_asignatura` INT NOT NULL,
  `horas` INT NOT NULL,
  PRIMARY KEY (`codigo`),
  INDEX `fk_oficio_asignaturas_idx` (`codigo_oficio` ASC),
  INDEX `fk_asignatura_td_asignaturas_idx` (`codigo_asignatura` ASC),
  CONSTRAINT `fk_oficio_td_asignaturas`
    FOREIGN KEY (`codigo_oficio`)
    REFERENCES `sistema_inces`.`t_oficio` (`codigo`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_asignatura_td_asignaturas`
    FOREIGN KEY (`codigo_asignatura`)
    REFERENCES `sistema_inces`.`t_asignatura` (`codigo`)
    ON DELETE NO ACTION
    ON UPDATE CASCADE)
