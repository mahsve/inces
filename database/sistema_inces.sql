...
CREATE TABLE IF NOT EXISTS `sistema_inces`.`t_empresa` (
  ...
  CONSTRAINT `fk_actividad_economica_empresa`
    ...
    ON DELETE NO ACTION
    ON UPDATE CASCADE,
  CONSTRAINT `fk_municipio_empresa`
...
CREATE TABLE IF NOT EXISTS `sistema_inces`.`t_datos_personales` (
  ...
  `sexo` CHAR(1) NULL,
  `fecha_n` DATE NULL,
  `codigo_ciudad_n` INT NULL,
  `lugar_n` VARCHAR(100) NULL,
  `codigo_ocupacion` INT NULL,
  `codigo_oficio` CHAR(10) NULL,
  ...
  INDEX `fk_municipio_datos_personales_idx` (`codigo_municipio` ASC),
  INDEX `fk_ciudad_n_datos_personales_idx` (`codigo_ciudad_n` ASC),
  INDEX `fk_oficio_datos_personales_idx` (`codigo_oficio` ASC),
  ...
  CONSTRAINT `fk_parroqui_datos_personales`
    ...
    ON DELETE NO ACTION
    ON UPDATE CASCADE,
  CONSTRAINT `fk_municipio_datos_personales`
    FOREIGN KEY (`codigo_municipio`)
    REFERENCES `sistema_inces`.`t_municipio` (`codigo`)
    ON DELETE NO ACTION
    ON UPDATE CASCADE,
  CONSTRAINT `fk_ciudad_n_datos_personales`
    FOREIGN KEY (`codigo_ciudad_n`)
    REFERENCES `sistema_inces`.`t_ciudad` (`codigo`)
    ON DELETE NO ACTION
    ON UPDATE CASCADE,
  CONSTRAINT `fk_oficio_datos_personales`
...
CREATE TABLE IF NOT EXISTS `sistema_inces`.`t_familia` (
  ...
  PRIMARY KEY (`numero`),
  INDEX `fk_aprendiz_tfamiliar_idx` (`nacionalidad` ASC, `cedula` ASC),
  INDEX `fk_familiar_tfamiliar_idx` (`nacionalidad_f` ASC, `cedula_f` ASC),
  CONSTRAINT `fk_aprendiz_tfamiliar`
    FOREIGN KEY (`nacionalidad` , `cedula`)
    REFERENCES `sistema_inces`.`t_datos_personales` (`nacionalidad` , `cedula`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_familiar_tfamiliar`
    FOREIGN KEY (`nacionalidad_f` , `cedula_f`)
    REFERENCES `sistema_inces`.`t_datos_personales` (`nacionalidad` , `cedula`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `sistema_inces`.`t_modulo` (
  `codigo` INT NOT NULL AUTO_INCREMENT,
  `nombre` VARCHAR(60) NOT NULL,
  `repetir_modulo` CHAR(1) NULL,
  `codigo_oficio` CHAR(10) NULL,
  `orden` INT NOT NULL,
  `estatus` CHAR(1) NOT NULL DEFAULT 'A',
  PRIMARY KEY (`codigo`),
  INDEX `fk_oficio_modulo_a_idx` (`codigo_oficio` ASC),
  CONSTRAINT `fk_oficio_modulo_a`
    FOREIGN KEY (`codigo_oficio`)
    REFERENCES `sistema_inces`.`t_oficio` (`codigo`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
...
CREATE TABLE IF NOT EXISTS `sistema_inces`.`td_modulo` (
  ...
  `codigo_oficio` CHAR(10) NOT NULL,
  `codigo_modulo` INT NOT NULL,
  `estatus` CHAR(1) NOT NULL DEFAULT 'A',
  PRIMARY KEY (`codigo`),
  INDEX `fk_oficio_tdmodulo_idx` (`codigo_oficio` ASC),
  INDEX `fk_modulo_tdmodulo_idx` (`codigo_modulo` ASC),
  CONSTRAINT `fk_oficio_tdmodulo`
    FOREIGN KEY (`codigo_oficio`)
    REFERENCES `sistema_inces`.`t_oficio` (`codigo`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
...
-- -----------------------------------------------------
-- Table `sistema_inces`.`td_seccion`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sistema_inces`.`td_seccion` (
  `codigo` INT NOT NULL AUTO_INCREMENT,
  `seccion` VARCHAR(11) NOT NULL,
  `turno` CHAR(1) NOT NULL,
  `codigo_modulo` INT NOT NULL,
  PRIMARY KEY (`codigo`),
  INDEX `fk_tdmodulo_tdseccion_idx` (`codigo_modulo` ASC),
  CONSTRAINT `fk_tdmodulo_tdseccion`
    FOREIGN KEY (`codigo_modulo`)
...
CREATE TABLE IF NOT EXISTS `sistema_inces`.`td_asignatura` (
  ...
  INDEX `fk_tdseccion_tdasignatura_idx` (`codigo_seccion` ASC),
  ...
  CONSTRAINT `fk_datos_facilitador_tdasignatura`
    ...
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_tdseccion_tdasignatura`
    FOREIGN KEY (`codigo_seccion`)
    REFERENCES `sistema_inces`.`td_seccion` (`codigo`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `sistema_inces`.`t_asistencia` (
  ...
  PRIMARY KEY (`numero`),
  INDEX `fk_aprendiz_asistencia_idx` (`numero_ficha` ASC),
  CONSTRAINT `fk_tdasignatura_asistencia`
    FOREIGN KEY (`codigo_asignatura`)
    REFERENCES `sistema_inces`.`td_asignatura` (`codigo`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_aprendiz_asistencia`
...
CREATE TABLE IF NOT EXISTS `sistema_inces`.`t_nota` (
  ...
  PRIMARY KEY (`codigo`),
  INDEX `fk_aprendiz_asignatura_idx` (`numero_ficha` ASC),
  CONSTRAINT `fk_nota_asignatura`
    FOREIGN KEY (`codigo_asignatura`)
    REFERENCES `sistema_inces`.`td_asignatura` (`codigo`)
    ON DELETE NO ACTION
    ON UPDATE CASCADE,
  CONSTRAINT `fk_aprendiz_asignatura`
    FOREIGN KEY (`numero_ficha`)
    REFERENCES `sistema_inces`.`t_ficha_aprendiz` (`numero`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
...
-- -----------------------------------------------------
-- Table `sistema_inces`.`t_cargo`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sistema_inces`.`t_cargo` (
  `codigo` INT NOT NULL AUTO_INCREMENT,
  `nombre` VARCHAR(80) NOT NULL,
  `estatus` CHAR(1) NOT NULL DEFAULT 'A',
  PRIMARY KEY (`codigo`))
...
-- -----------------------------------------------------
-- Table `sistema_inces`.`td_contacto`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sistema_inces`.`td_contacto` (
  `numero` INT NOT NULL AUTO_INCREMENT,
  `rif` VARCHAR(12) NOT NULL,
  `nacionalidad` CHAR(1) NOT NULL,
  `cedula` VARCHAR(12) NOT NULL,
  ...
  PRIMARY KEY (`numero`),
  INDEX `fk_contacto_cargo_idx` (`codigo_cargo` ASC),
  INDEX `fk_empresa_contacto_idx` (`rif` ASC),
  INDEX `fk_persona_contacto_idx` (`nacionalidad` ASC, `cedula` ASC),
  CONSTRAINT `fk_contacto_cargo`
    FOREIGN KEY (`codigo_cargo`)
    REFERENCES `sistema_inces`.`t_cargo` (`codigo`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_empresa_contacto`
    FOREIGN KEY (`rif`)
    REFERENCES `sistema_inces`.`t_empresa` (`rif`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
...
-- -----------------------------------------------------
-- Table `sistema_inces`.`t_modulo_asig`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sistema_inces`.`t_modulo_asig` (
  `codigo` INT NOT NULL AUTO_INCREMENT,
  `codigo_modulo` INT NOT NULL,
  `codigo_asignatura` INT NOT NULL,
  `horas` INT NOT NULL,
  INDEX `fk_modulo_td_modulo_asig_idx` (`codigo_modulo` ASC),
  INDEX `fk_asignatura_td_modulo_asig_idx` (`codigo_asignatura` ASC),
  PRIMARY KEY (`codigo`),
  CONSTRAINT `fk_modulo_td_modulo_asig`
    FOREIGN KEY (`codigo_modulo`)
    REFERENCES `sistema_inces`.`t_modulo` (`codigo`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_asignatura_td_modulo_asig`
    FOREIGN KEY (`codigo_asignatura`)
    REFERENCES `sistema_inces`.`t_asignatura` (`codigo`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
...
-- -----------------------------------------------------
-- Table `sistema_inces`.`t_oficio_modulo`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sistema_inces`.`t_oficio_modulo` (
  `codigo_oficio` CHAR(10) NOT NULL,
  `codigo_modulo` INT NOT NULL,
  INDEX `fk_oficio_oficio_modl_idx` (`codigo_oficio` ASC),
  INDEX `fk_modulo_oficio_modl_idx` (`codigo_modulo` ASC),
  CONSTRAINT `fk_oficio_oficio_modl`
    FOREIGN KEY (`codigo_oficio`)
    REFERENCES `sistema_inces`.`t_oficio` (`codigo`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_modulo_oficio_modl`
    FOREIGN KEY (`codigo_modulo`)
    REFERENCES `sistema_inces`.`t_modulo` (`codigo`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
...
-- -----------------------------------------------------
-- Table `sistema_inces`.`td_facilitador_asig`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sistema_inces`.`td_facilitador_asig` (
  `codigo` INT NOT NULL AUTO_INCREMENT,
  `codigo_asignatura` INT NOT NULL,
  `nacionalidad_f` CHAR(1) NOT NULL,
  `cedula_f` VARCHAR(12) NOT NULL,
  INDEX `fk_asignatura_facilitador_idx` (`codigo_asignatura` ASC),
  PRIMARY KEY (`codigo`),
  INDEX `fk_dfacilitador_facilitador_idx` (`nacionalidad_f` ASC, `cedula_f` ASC),
  CONSTRAINT `fk_asignatura_facilitador`
    FOREIGN KEY (`codigo_asignatura`)
    REFERENCES `sistema_inces`.`t_asignatura` (`codigo`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_dfacilitador_facilitador`
    FOREIGN KEY (`nacionalidad_f` , `cedula_f`)
    REFERENCES `sistema_inces`.`t_datos_personales` (`nacionalidad` , `cedula`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
...
-- -----------------------------------------------------
-- Table `sistema_inces`.`t_contrasenas`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sistema_inces`.`t_contrasenas` (
  `numero` INT NOT NULL AUTO_INCREMENT,
  `usuario` VARCHAR(30) NOT NULL,
  `fecha` DATE NOT NULL,
  `contrasena` VARCHAR(255) NOT NULL,
  PRIMARY KEY (`numero`),
  INDEX `fk_usuario_contrasenas_idx` (`usuario` ASC),
  CONSTRAINT `fk_usuario_contrasenas`
    FOREIGN KEY (`usuario`)
    REFERENCES `sistema_inces`.`t_usuario` (`usuario`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
...
-- -----------------------------------------------------
-- Table `sistema_inces`.`td_fechas_nl`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sistema_inces`.`td_fechas_nl` (
  `codigo` INT NOT NULL AUTO_INCREMENT,
  `fecha_inicio` DATE NOT NULL,
  `fecha_fin` DATE NULL,
  `descripcion` VARCHAR(150) NOT NULL,
  `codigo_asignatura` INT NOT NULL,
  PRIMARY KEY (`codigo`),
  INDEX `fk_fechas_nl_tdasignatura_idx` (`codigo_asignatura` ASC),
  CONSTRAINT `fk_fechas_nl_tdasignatura`
    FOREIGN KEY (`codigo_asignatura`)
    REFERENCES `sistema_inces`.`td_asignatura` (`codigo`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
