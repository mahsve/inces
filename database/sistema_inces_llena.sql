...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-03-2020 a las 12:07:55
...
CREATE TABLE `t_bitacora` (
  ...
  `valor_viejo` varchar(2000) DEFAULT NULL,
  `valor_nuevo` varchar(2000) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `t_datos_hogar` (
  ...
  `punto_referencia` varchar(300) NOT NULL,
  ...
  `techo` varchar(250) NOT NULL,
  `paredes` varchar(250) NOT NULL,
  `piso` varchar(250) NOT NULL,
  `via_acceso` varchar(250) NOT NULL,
  `sala` int(1) NOT NULL,
...
('V', '25791680', 'Donde está la buseta', 'U', 'Q', 'I', 'A', 'L', 'C', 'A', 'Ninguna', 'Madera 2', 'Bloques 2', 'Granito 2', 'Calle 2', 2, 3, 4, 5, 6),
('V', '25791967', 'Desde la entrada, 7 calles a la derecha, la ultima casa donde esta la buseta beige 2', 'R', 'C', 'P', 'A', 'L', 'A', 'U', 'Ninguna', 'Madera', 'Bloques', 'Granito', 'Calle', 1, 1, 1, 1, 4),
('V', '25791968', 'Desde la entrada, 7 calles a la derecha, la ultima casa donde esta la buseta beige', 'U', 'C', 'P', 'A', 'L', 'A', 'U', 'Ninguna', 'Madera', 'Bloques', 'Granito', 'Calle', 1, 1, 1, 1, 4),
('E', '13584635', 'En la buseta', 'R', 'C', 'P', 'A', 'L', 'A', 'U', 'Ninguna', 'Madera', 'Bloques', 'Granito', 'Calle', 1, 1, 1, 1, 5),
('V', '24791966', 'Segunda entrada, 7 calles a la izquierda, ultima casa verdad, buseta color beige', 'R', 'C', 'P', 'A', 'L', 'A', 'U', '', 'Madera', 'Bloques', 'Granito', 'Calle', 1, 1, 1, 1, 3),
('V', '25791966', 'Donde esta la buseta', 'R', 'Q', 'P', 'A', 'L', '', '', '', 'Madera', 'Bloques', 'Granito', 'Calle', 1, 1, 1, 1, 3),
('V', '25791969', '7 Calles girar a la izquierda', 'U', 'A', 'E', 'P', 'I', 'L', 'Q', '', 'Madera', 'Bloques', 'Granito', 'Calle', 1, 1, 1, 1, 3),
('E', '25791600', 'Desde la entrada, 7 calles a la derecha', 'U', 'C', 'P', 'A', 'L', 'C', 'A', '', 'Madera', 'Bloques', 'Granito', 'Calle', 1, 1, 1, 1, 3),
('V', '25791961', 'asdasd', 'U', 'C', 'P', 'A', 'L', 'C', 'A', '', 'asdasd', 'asdasd', 'asdasd', 'asdasd', 1, 1, 1, 1, 1),
('E', '25791962', '7 Calles a la derecha', 'U', 'C', 'P', 'A', 'L', 'C', 'A', '', 'Madera', 'Bloques', 'Granito', 'Calle', 1, 1, 1, 1, 3),
('E', '25791965', 'asdasd', 'R', 'Q', 'P', 'A', 'L', 'C', 'A', '', 'asdasd', 'asdasd', 'asda', 'sdasadasd', 1, 1, 1, 1, 1),
('E', '25791961', 'asdasd', 'U', 'C', 'P', 'A', 'L', 'C', 'A', '', 'aasdasd', 'asd', 'asdasd', 'asdasd', 1, 1, 1, 1, 1);
...
('E', '13584635', 'Sandra', 'Jenne', 'Soto', 'De herrera', 'M', '1975-07-20', 'Hospital', 1, 'S', 'SC', 'Licenciada en educacion mension biologia', 'Ninguna', 355, 732, 'Urb. prados del sol, sector morichal', '04169355324', '04245300430', 'sandrasot-@hotmail.com', 'B', 'A'),
('E', '23584698', 'asdasdasd', 'asdasd', 'asdasd', 'asdasdasd', 'I', '1994-06-22', NULL, 2, 'S', 'SC', 'asdasd', 'asdasd', 3, NULL, 'asdasdasd', '123123', '123123', 'asdasd@gmail.com', 'F', 'A'),
('E', '25791600', 'Miguel', '', 'Herrera', '', 'M', '0000-00-00', '', 2, 'S', 'SI', 'Ingeniería informática', '', 339, 740, 'Urb. prados del sol, sector morichal', '02556634386', '', '', 'B', 'A'),
('E', '25791961', 'Miguel', 'Alejandro', 'Herrera', 'Soto', 'F', '2002-10-31', '', 7, 'S', 'MI', '', '', 339, 739, 'asdasd', '02556634386', '', '', 'B', 'A'),
('E', '25791962', 'Miguel', '', 'Alejandro', '', 'M', '2002-10-31', '', 1, 'S', 'BI', '', '', 339, 739, 'Urb. prados del sol', '02556634386', '', '', 'B', 'A'),
('E', '25791965', 'miguel', 'Alejandro', 'Herrera', '', 'M', '2002-10-31', '', 2, 'S', 'BI', '', '', 91, 241, 'xasasdasdasd', '02556634386', '', '', 'B', 'A'),
('V', '10142010', 'Ramon', 'Alberto', 'Herrera', 'Hernadez', 'M', '1969-02-08', NULL, 2, 'C', 'SC', 'Ingeniero electromecánico', 'Ninguna', 339, 742, 'Urb. prados del sol, sector morichal 2', '04120570120', '04120570120', 'ramonher-@hotmail.com', 'F', 'I'),
('V', '13584631', 'Sandra', 'Jenne', 'Soto ', 'De Herrera', 'M', '1975-07-20', NULL, 2, 'C', 'SI', 'Licenciada en educación', 'Ninguna', 45, 89, 'asdasdasd', '04120570120', '04120570120', 'sandrasot-@hotmail.com', 'F', 'A'),
('V', '13584698', 'Miguel', 'Alejandro', 'Herrera', 'Soto', 'M', '1997-10-31', NULL, 2, 'S', 'SI', 'Ingeniería informática', '', 46, NULL, 'Hola 2 2', '04120570120', '04120570120', 'miguelsot959@hotmail.com', 'F', 'A'),
('V', '24791966', 'Miguel', 'Alejandro', 'Herrera', 'Soto', 'M', '1997-10-31', 'Seguro social', 1, 'X', 'SI', 'Ingeniería informática', 'Ninguna', 339, 739, 'Urb. Prados del sol, sector Morichal, calle 7, Manzana G, Casa 11', '02556634386', '04245071156', 'miguelsot959@hotmail.com', 'B', 'A'),
('V', '25791680', 'Miguel', 'Alejandro', 'Herrera', 'Soto', 'M', '2002-10-31', 'En un hospital', 2, 'C', 'SC', 'Ingeniería informática', 'Hola', 341, 722, 'Urb prados del sol sector morichal', '02556634386', '04245071156', 'miguelsot959@gmail.com', 'B', 'A'),
('V', '25791961', 'Miguel', 'Alejandro', 'Herrera', 'Soto', 'M', '0000-00-00', '', 7, 'C', 'SI', 'Ingeniería informática', '', 339, 723, 'asdasda', '02556634386', '', '', 'B', 'A'),
('V', '25791966', 'Miguel', 'Alejandro', 'Herrera', 'Soto', 'M', '1997-10-31', 'Seguro social', 1, 'D', 'SI', 'Ingeniería informática', 'asdasdasd', 339, 739, 'Urb. Prados del sol, sector morichal, calle 7, manzana G, casa 11', '02556634386', '04120570120', 'miguelsot959@hotmail.com', 'B', 'A'),
('V', '25791967', 'Miguel', 'Alejandro', 'Herrera', 'Soto', 'M', '1997-10-31', 'Seguro social', 1, 'S', 'SI', 'Ingeniería informática', 'Hola como estas', 2, 7, 'Urb. prados del sol, sector morichal, calle 7 manzana g, casa numero 11 2', '02556634386', '04120570120', 'miguelsot959@hotmail.com', 'B', 'A'),
('V', '25791968', 'Miguel', 'Alejandro', 'Herrera', 'Soto', 'M', '1997-10-31', 'Seguro social', 1, 'S', 'SI', 'Ingeniería informática', 'Hola como estas', 341, 723, 'Urb. prados del sol, sector morichal, calle 7 manzana g, casa numero 11', '02556634386', '04120570120', 'miguelsot959@hotmail.com', 'B', 'A'),
('V', '25791969', 'Miguel', 'Alejandro', 'Herrera', 'Soto', 'M', '1997-10-31', 'Seguro social', 2, 'V', 'SI', 'Ingeniería informática', 'Ninguna', 45, 90, 'Urb prados del sol', '02556634386', '04120570120', 'miguelsot959@hotmail.com', 'B', 'A'),
('V', '26791966', 'Miguel 2', 'Alejandro', 'Herrera', 'Soto', 'M', '1997-10-31', NULL, NULL, 'I', 'I', NULL, NULL, 339, 744, 'Urb. prados del sol, sector morichal', '04120570120', '02556634386', 'miguelsot959@hotmail.com', 'A', 'A');
...
CREATE TABLE `t_documentos` (
  `idt_documentos` int(11) NOT NULL,
  `enlace` varchar(45) DEFAULT NULL,
  `t_documentoscol` varchar(45) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `t_empresa` (`rif`, `nil`, `razon_social`, `codigo_actividad`, `codigo_aportante`, `telefono1`, `telefono2`, `codigo_ciudad`, `direccion`, `nacionalidad_contacto`, `persona_contacto`, `estatus`) VALUES
('G-123456789', '12345678', 'Exportaciones 1', 1, 'A132456', '02556643929', '02556643929', 56, 'Hola 2', 'V', '13584698', 'I'),
('J-123456789', '13246578', 'Inversiones venezuela', 1, 'E123456', '132456', '123456', 58, 'asdasdasd', 'V', '10142010', 'A');
...
(2, 3, 'ramon', 'alberto', 'herrera', 'hernandez', '1975-07-26', 'M', '0', 1, 'S', 1000000),
(3, 4, 'sandra', 'jenne', 'soto', 'herrera', '1975-06-20', 'F', '0', 1, 'S', 150000),
(7, 2, 'Sandra', 'Jenne', 'Soto', 'De herrera', '1974-07-21', 'F', '0', 1, 'N', 0),
(8, 5, 'ramon', 'alberto', 'herrera', 'hernandez', '1969-02-08', 'M', '0', 2, 'S', 1500000),
(9, 6, 'Sandra 1', 'Jenne 2', 'Soto 3', 'de Herrera 4', '1975-07-20', 'F', '0', 1, 'S', 132.12),
(11, 7, 'Ramon', 'Alberto', 'Herrera', 'Soto', '1969-02-08', 'M', '0', 2, 'S', 1500000),
(12, 7, 'Sandra', 'Jenne', 'Soto', 'De herrera', '1975-07-20', 'F', '0', 2, 'S', 1000000),
(13, 7, 'Gabriel', 'Alberto', 'Herrera', 'Soto', '1992-09-01', 'M', '1', 1, 'N', 0),
(14, 7, 'Yanetsy', 'Alexandra', 'Herrera', 'Soto', '2000-03-26', 'F', '1', 1, 'S', 800000),
(15, 8, 'Sandra', 'Jenne', 'Soto', 'De herrera', '1975-07-20', 'F', '0', 1, 'S', 1000000),
(16, 8, 'Ramon', 'Alberto', 'Herrera', 'Hernandez', '1969-02-08', 'M', '0', 1, 'S', 1500000),
(17, 9, 'Ramon', '', 'Herrera', '', '0000-00-00', 'M', '0', 1, 'S', 1500000),
(18, 9, 'Sandra', '', 'Soto', '', '0000-00-00', 'F', '0', 4, 'S', 1000000),
(19, 10, 'asd', 'asd', 'asd', 'asd', '0000-00-00', 'M', '0', 2, 'S', 11111),
(20, 11, 'Ramon', '', 'Herrera', '', '1969-02-08', 'M', '0', 1, 'S', 1000000),
(21, 11, 'Sandra', '', 'Jenne', '', '1975-07-20', 'F', '0', 5, 'S', 1500000),
(22, 11, 'Gabriel', '', 'Gerrera', '', '1992-09-01', 'M', '1', 4, 'N', 0),
(23, 12, 'asdasd', 'asd', 'asda', 'sdasd', '2020-03-11', 'M', '1', 2, 'N', 0),
(24, 13, 'sadasd', 'asdasd', 'asd', 'asdasd', '2010-01-14', 'M', '1', 6, 'N', 0);
...
--
-- Volcado de datos para la tabla `t_ficha_aprendiz`
--

INSERT INTO `t_ficha_aprendiz` (`numero`, `fecha`, `tipo_inscripcion`, `ficha_anterior`, `correlativo`, `numero_orden`, `numero_informe`, `empresa_actual`, `estatus`) VALUES
(2, '2020-03-05', 'M', NULL, '123', '123', 2, 'J-123456789', 'I'),
(3, '2020-03-05', 'M', NULL, '123', '123', 3, 'J-123456789', 'I'),
(4, '2020-03-05', 'M', NULL, '1324', '123', 6, 'J-123456789', 'I');
...
(3, 'ingreso_pension', 1000),
(3, 'ingreso_seguro', 1000),
(3, 'ingreso_pension_otras', 1000),
(3, 'ingreso_sueldo', 1000),
(3, 'otros_ingresos', 1000),
(3, 'egreso_servicios', 1000),
(3, 'egreso_alimentario', 1000),
(3, 'egreso_educacion', 1000),
(3, 'egreso_vivienda', 1000),
(3, 'otros_egresos', 1000),
(5, 'ingreso_pension', 100),
(5, 'ingreso_seguro', 300),
(5, 'ingreso_pension_otras', 500),
(5, 'ingreso_sueldo', 700),
(5, 'otros_ingresos', 900),
(5, 'egreso_servicios', 200),
(5, 'egreso_alimentario', 400),
(5, 'egreso_educacion', 600),
(5, 'egreso_vivienda', 800),
(5, 'otros_egresos', 1000),
(4, 'ingreso_pension', 1000),
(4, 'ingreso_seguro', 2000),
(4, 'ingreso_pension_otras', 3000),
(4, 'ingreso_sueldo', 4000),
(4, 'otros_ingresos', 5000),
(4, 'egreso_servicios', 6000),
(4, 'egreso_alimentario', 7000),
(4, 'egreso_educacion', 8000),
(4, 'egreso_vivienda', 9000),
(4, 'otros_egresos', 10000),
(6, 'ingreso_pension', 1000),
(6, 'ingreso_seguro', 3000),
(6, 'ingreso_pension_otras', 500),
(6, 'ingreso_sueldo', 7000),
(6, 'otros_ingresos', 900),
(6, 'egreso_servicios', 2000),
(6, 'egreso_alimentario', 4000),
(6, 'egreso_educacion', 600),
(6, 'egreso_vivienda', 8000),
(6, 'otros_egresos', 1200),
(8, 'ingreso_pension', 0),
(8, 'ingreso_seguro', 0),
(8, 'ingreso_pension_otras', 0),
(8, 'ingreso_sueldo', 0),
(8, 'otros_ingresos', 0),
(8, 'egreso_servicios', 0),
(8, 'egreso_alimentario', 0),
(8, 'egreso_educacion', 0),
(8, 'egreso_vivienda', 0),
(8, 'otros_egresos', 0),
(7, 'ingreso_pension', 10),
(7, 'ingreso_seguro', 20),
(7, 'ingreso_pension_otras', 30),
(7, 'ingreso_sueldo', 40),
(7, 'otros_ingresos', 50),
(7, 'egreso_servicios', 60),
(7, 'egreso_alimentario', 70),
(7, 'egreso_educacion', 80),
(7, 'egreso_vivienda', 90),
(7, 'otros_egresos', 100),
(9, 'ingreso_pension', 0),
(9, 'ingreso_seguro', 0),
(9, 'ingreso_pension_otras', 0),
(9, 'ingreso_sueldo', 0),
(9, 'otros_ingresos', 0),
(9, 'egreso_servicios', 0),
(9, 'egreso_alimentario', 0),
(9, 'egreso_educacion', 0),
(9, 'egreso_vivienda', 0),
(9, 'otros_egresos', 0),
...
(10, 'otros_egresos', 0),
(11, 'ingreso_pension', 0),
(11, 'ingreso_seguro', 0),
(11, 'ingreso_pension_otras', 0),
(11, 'ingreso_sueldo', 0),
(11, 'otros_ingresos', 0),
(11, 'egreso_servicios', 0),
(11, 'egreso_alimentario', 0),
(11, 'egreso_educacion', 0),
(11, 'egreso_vivienda', 0),
(11, 'otros_egresos', 0),
(12, 'ingreso_pension', 0),
(12, 'ingreso_seguro', 0),
(12, 'ingreso_pension_otras', 0),
(12, 'ingreso_sueldo', 0),
(12, 'otros_ingresos', 0),
(12, 'egreso_servicios', 0),
(12, 'egreso_alimentario', 0),
(12, 'egreso_educacion', 0),
(12, 'egreso_vivienda', 0),
(12, 'otros_egresos', 0),
(13, 'ingreso_pension', 0),
(13, 'ingreso_seguro', 0),
(13, 'ingreso_pension_otras', 0),
(13, 'ingreso_sueldo', 0),
(13, 'otros_ingresos', 0),
(13, 'egreso_servicios', 0),
(13, 'egreso_alimentario', 0),
(13, 'egreso_educacion', 0),
(13, 'egreso_vivienda', 0),
(13, 'otros_egresos', 0),
(2, 'ingreso_pension', 10),
(2, 'ingreso_seguro', 2),
(2, 'ingreso_pension_otras', 10),
(2, 'ingreso_sueldo', 10),
(2, 'otros_ingresos', 10),
(2, 'egreso_servicios', 0),
(2, 'egreso_alimentario', 4000),
(2, 'egreso_educacion', 600),
(2, 'egreso_vivienda', 800),
(2, 'otros_egresos', 7000);
...
(2, '2020-02-19', 'V', '25791680', 'INF123', 'M', 'V', '26791966', 'Hola 2', 'hola 2', 'hola 3', 'hola 4', 'hola 5', 'N', 1, 'A'),
(3, '2020-02-19', 'V', '25791967', 'INF123', 'V', 'V', '26791966', 'Hola 1', 'hola 2', 'Hola 3', 'Hola 4', 'Hola  5', 'S', 1, 'A'),
(4, '2020-02-19', 'V', '25791968', 'INF123', 'V', 'V', '26791966', '', '', '', '', '', '', 1, 'R'),
(5, '2020-02-20', 'E', '13584635', 'INF123', 'M', 'V', '26791966', 'hola 1', 'hola 2', 'hola 3', 'hola 4', 'hola 5', 'S', 1, 'R'),
(6, '2020-02-23', 'V', '24791966', 'INF123', 'M', 'E', '23584698', 'Hola 1', 'Hola 2', 'Hola 3', 'Hola 4', 'Hola 5', 'N', 1, 'A'),
(7, '2020-02-26', 'V', '25791966', 'INF123', 'M', 'V', '26791966', 'Condiciones', 'Características', 'Diagnóstico social', 'Diagnóstico preliminar', 'Conclusiones y recomendacione', 'N', 2, 'E'),
(8, '2020-02-26', 'V', '25791969', 'INF123', 'M', 'V', '26791966', 'asd', 'asd', 'asdas', 'asda', 'asdasd', 'S', 1, 'E'),
(9, '0000-00-00', 'E', '25791600', 'INF123', 'M', 'V', '26791966', 'Condiciones generales de la vivienda', 'Características generales de las relaciones familiares y sus condiciones socioeconómicas', 'Diagnóstico social', 'Diagnóstico preliminar', 'Conclusiones y recomendaciones', 'S', 1, 'E'),
(10, '0000-00-00', 'V', '25791961', 'INF123', 'M', 'V', '26791966', 'asdasda', 'asda', 'asd', 'asd', 'asdasd', 'S', 1, 'E'),
(11, '2020-03-04', 'E', '25791962', 'INF123', 'M', 'V', '26791966', 'HOla 1', 'hola 2', 'hola 3', 'hola 4', 'hola 5', 'S', 1, 'E'),
(12, '2020-03-04', 'E', '25791965', 'INF123', 'M', 'V', '26791966', 'asdasd', 'asd', 'asdasd', 'asdasd', 'asdasd', 'S', 1, 'E'),
(13, '2020-03-04', 'E', '25791961', 'INF123', 'V', 'V', '26791966', 'asdasda', 'sdasd', 'as', 'dasd', 'asdasd', 'S', 1, 'E');
...
(1, 'Inscripción', 1, 'fas fa-user-plus'),
...
(1, 'Estudiante', 'A'),
(2, 'Profesor de Informática', 'A'),
(3, 'asdasd', 'A'),
(4, 'asdasdasdsdad', 'A'),
(5, 'Mecanico', 'A'),
(6, 'Mecanico 2', 'A'),
(7, 'Ayudante voluntario', 'A'),
(8, 'Ejemplo 2', 'A'),
(9, 'Nuevo 3', 'A'),
(10, 'Nuevo 4', 'A');
...
ALTER TABLE `t_asignatura`
  ADD PRIMARY KEY (`codigo`),
  ADD KEY `fk_modulo_asinatura_idx` (`codigo_modulo`);
...
ALTER TABLE `t_documentos`
  ADD PRIMARY KEY (`idt_documentos`);
...
--
ALTER TABLE `t_documentos`
  MODIFY `idt_documentos` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `t_familia`
  MODIFY `id_familiar` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
...
--
ALTER TABLE `t_asignatura`
  ADD CONSTRAINT `fk_modulo_asinatura` FOREIGN KEY (`codigo_modulo`) REFERENCES `t_modulo` (`codigo`) ON DELETE NO ACTION ON UPDATE CASCADE;
