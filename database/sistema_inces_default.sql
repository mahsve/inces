...
(3, 8, 'Facilitador', 'facilitador', 6, 'fas fa-chalkboard-teacher'),
(4, 4, 'Empresa', 'empresa', 2, 'fas fa-industry'),
(5, 4, 'Actividad económica', 'actividad_economica', 3, 'fas fa-wallet'),
(6, 8, 'Ocupación', 'ocupacion', 7, 'fas fa-briefcase'),
(7, 8, 'Oficio aprendiz', 'oficio', 3, 'fas fa-graduation-cap'),
(8, 8, 'Asignatura', 'asignatura', 5, 'fas fa-book'),
(9, 5, 'Rol de usuario', 'rol', 3, 'fas fa-user-tag'),
(10, 5, 'Módulo sistema', 'modulo_sistema', 4, 'fas fa-sitemap'),
(11, 5, 'Vista del sistema', 'vista_sistema', 5, 'far fa-window-maximize'),
(12, 5, 'Usuario', 'usuario', 2, 'fas fa-users'),
(13, 6, 'Datos personales', 'datos_personales', 1, 'fas fa-id-card'),
(14, 6, 'Seguridad', 'seguridad', 2, 'fas fa-user-shield'),
(15, 7, 'Asistencias', 'asistencias', 2, 'fas fa-clipboard-list'),
(16, 7, 'Notas', 'notas', 1, 'fas fa-address-book'),
(17, 5, 'Base de datos', 'respaldo_db', 1, 'fas fa-database'),
(18, 8, 'Módulos en curso', 'modulo_curso', 1, 'fas fa-chalkboard'),
(19, 8, 'Asignaturas en curso', 'asignatura_curso', 2, 'fas fa-book-reader'),
(20, 4, 'Cargo contacto', 'cargo_contacto', 4, 'fas fa-id-card-alt'),
(21, 8, 'Módulo / Unidad', 'modulo', 4, 'fas fa-sitemap'),
(22, 1, 'Aspirante', 'aspirante', 1, 'fas fa-book-reader'),
(23, 4, 'Administrativo', 'administrativo', 1, 'fas fa-user-tie');
